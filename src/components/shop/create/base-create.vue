<template>
	<el-form ref="form" label-width="80px">
		<el-form-item label="商品名称">
			<el-input placeholder="请输入商品名称，不能超过60个字符" class="w-50" :value="title" @input="vModel('title', $event)"></el-input>
		</el-form-item>
		...
		<el-form-item label="商品单位"><el-input placeholder="请输入商品单位" class="w-50" :value="unit" @input="vModel('unit', $event)"></el-input></el-form-item>
		<el-form-item label="总库存">
			<el-input type="number" placeholder class="w-25" :value="stock" @input="vModel('stock', $event)">
		...
		<el-form-item label="库存预警">
			<el-input type="number" placeholder class="w-25" :value="min_stock" @input="vModel('min_stock', $event)">
				<template slot="append">
					件
				</template>
			</el-input>
