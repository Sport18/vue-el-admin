<template>
	<div class="card mb-3" style="line-height: 1.2;">
		<div class="card-header d-flex align-items-center">
			...
			<el-radio-group size="mini" style="margin-bottom: -10px;" class="ml-3" :value="item.type" @input="vModel('type', index, $event)">
		...
		<div class="card-body">
			...
			<!-- 增加规格属性 -->
			<div class="mt-2"><el-button type="text" size="mini" icon="el-icon-plus" @click="addSkuValue(index)">增加规格值</el-button></div>
		</div>
	</div>
</template>
