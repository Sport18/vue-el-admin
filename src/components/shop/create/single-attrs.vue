<template>
	<el-form ref="form" label-width="80px">
		...
		<el-form-item label="销售价格">
			<el-input type="number" class="w-25" :value="pprice" @input="vModel('pprice', $event)">
				<template slot="append">
					元
				</template>
			</el-input>
		...
		<el-form-item label="成本价格">
			<el-input type="number" class="w-25" :value="cprice" @input="vModel('cprice', $event)">
				<template slot="append">
					元
				</template>
			</el-input>
		...
		<el-form-item label="商品重量">
			<el-input type="number" class="w-25" :value="weight" @input="vModel('weight', $event)">
				<template slot="append">
					公斤
				</template>
			</el-input>
		...
		<el-form-item label="商品体积">
			<el-input type="number" class="w-25" :value="volume" @input="vModel('volume', $event)">
				<template slot="append">
					立方米
				</template>
			</el-input>
