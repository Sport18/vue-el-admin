<template>
	<div class="bg-white px-3" style="margin: -20px; margin-top: -1rem; margin-bottom: 60px!important;">
		...
		<el-table :data="tableData" style="width: 100%" border class="mt-3" @selection-change="handleSelectionChange">
			...
			<el-table-column prop="price" label="开票金额" align="center"></el-table-column>
			<el-table-column prop="price" label="抬头" align="center"></el-table-column>
			<el-table-column prop="price" label="发票内容" align="center"></el-table-column>
			<el-table-column prop="content" label="开票金额" align="center"></el-table-column>
			<el-table-column prop="code" label="纳税人识别号" align="center"></el-table-column>
			<el-table-column prop="create_time" label="常见时间" align="center"></el-table-column>
