<template>
	<div class="bg-white px-3" style="margin: -20px; margin-top: -1rem; margin-bottom: 60px!important;">
		...
		<el-table :data="tableData" style="width: 100%" border class="mt-3" @selection-change="handleSelectionChange">
			...
			<el-table-column prop="value" label="规格值" width="380" align="center"></el-table-column>
		...
		<el-dialog title="添加规格" :visible.sync="createModel" top="5vh">
			...
			<el-form :model="form" label-width="80px" :rules="rules" ref="form">
				...
				<el-form-item label="规格值" prop="value">
					<el-input type="textarea" :rows="2" placeholder="一行一个规格项,多个规格项用换行输入" v-model="form.value"></el-input>
				</el-form-item>
			</el-form>
