<template>
	<div class="bg-white px-3 goods_create" style="margin: -20px; margin-top: -1rem; margin-bottom: 60px!important;">
		<router-link :to="{ name: 'shop_goods_list' }" style="position: absolute; top: 12px; left: 180px;"><el-button size="mini">回到商品列表</el-button></router-link>
		<el-tabs v-model="tabIndex" @tab-click="handleClick">
				...
				<el-form ref="form" label-width="80px">
					<el-form-item label="商品规格" label-width="80px">
						<el-radio-group :value="skus_type" @input="vModel('skus_type', $event)" size="medium">
							<el-radio-button :label="0" border>统一规格</el-radio-button>
					...
					<el-form label-width="80px">
						<el-form-item label="批量设置" label-width="80px">
							...
							<div class="d-flex align-items-center" v-else>
								<el-input size="small" style="width: 150px;" class="mr-3" type="number" v-model="UpdateAllValue" :placeholder="updateAllPlaceholder"></el-input>
						...
						<el-form-item label="规格设置" label-width="80px"><sku-table ref="table"></sku-table></el-form-item>
					</el-form>
				</template>
			</el-tab-pane>
			...
			<el-tab-pane label="商品详情">
				<!-- 富文本编辑器 -->
				<tinymce v-model="msg" @onClick="onClick" ref="editor"></tinymce>
			</el-tab-pane>
			<el-tab-pane label="折扣设置">
				<el-form>
					<el-form-item label="会员价" class="d-flex align-items-center">
						<el-input :value="discount" @input="vModel('discount', $event)" size="small" style="width: 200px;">
